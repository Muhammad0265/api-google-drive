...
use App\Controller\UserMediaCreateAction;
...
//            security: "is_granted('ROLE_ADMIN')",
        ...
        new Post(
            uriTemplate: '/user/media',
            controller: UserMediaCreateAction::class,
    ...
    PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Email]
    #[Groups(['users:read', 'user:write', 'user:put:write', 'user:isUniqueEmail:write','user-media:write'])]
    ...
    #[Groups(['users:read', 'user:write','user-media:write'])]
    private ?string $fullName = null;

    #[ORM\OneToOne(cascade: ['persist', 'remove'])]
    #[Groups(['users:read', 'user:write'])]
    private ?UserImageMediaObject $image = null;
    ...
    public function getImage(): ?UserImageMediaObject
    {
        return $this->image;
    }

    public function setImage(?UserImageMediaObject $image): self
    {
        $this->image = $image;
    ...
    public function setClerkId(?string $clerkId): self
    {
